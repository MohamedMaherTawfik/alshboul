    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title card_title_center">تعديل نوع معاملات</h3>
            </div>
            <div class="card-body">
                <form action="{{ route('transactions.update.new', $type) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input class="form-control" type="text" name="" id="" value="معاملات"
                                readonly>
                        </div>
                    </div>
