<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <a class="navbar-brand d-flex align-items-center" href="{{ route('admin.dashboard') }}">
    <img src="{{ asset('assets/admin/imgs/logoFull.png') }}" style="width: 100px; height: 50px; opacity: .8" alt="Logo">
  </a>
...
<li class="nav-item dropdown">
  <a class="nav-link dropdown-toggle {{ request()->is('admin/about*') || request()->is('admin/move-bars*') || request()->is('admin/casetypes*') || request()->is('admin/social-links*') || request()->is('admin/sliders*') ? 'active' : '' }}" href="#" data-toggle="dropdown">
    إعدادات الموقع
  </a>
...
<!-- إدارة المستخدمين -->
<li class="nav-item dropdown">
  <a class="nav-link dropdown-toggle {{ request()->is('admin/user*') || request()->is('admin/lawyer*') || request()->is('admin/client*') || request()->is('admin/request*') || request()->is('admin/action*') || request()->is('admin/visit*') ? 'active' : '' }}" href="#" data-toggle="dropdown">
    إدارة المستخدمين
  </a>
  <div class="dropdown-menu dropdown-menu-right">
...
<li class="nav-item dropdown">
  <a class="nav-link dropdown-toggle {{ request()->is('admin/agreement*') ? 'active' : '' }}" href="#" data-toggle="dropdown">
الاتفاقيات  </a>
  <div class="dropdown-menu dropdown-menu-right">
...
<!-- إدارة الوظائف -->
<li class="nav-item dropdown">
  <a class="nav-link dropdown-toggle {{ request()->is('admin/careers*') || request()->is('admin/apply-careers*') ? 'active' : '' }}" href="#" data-toggle="dropdown">
    الوظائف
  </a>
  <div class="dropdown-menu dropdown-menu-right">
...
<!-- الدردشة -->
<li class="nav-item dropdown">
  <a class="nav-link dropdown-toggle {{ request()->is('admin/chat*') ? 'active' : '' }}" href="#" data-toggle="dropdown">
    الدردشة
  </a>
  <div class="dropdown-menu dropdown-menu-right">
...
<li class="nav-item dropdown">
    <a class="nav-link dropdown-toggle {{ request()->is('admin/*Delete*') ? 'active' : '' }}" href="#" id="deletedItemsMenu" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        العناصر المحذوفة
    </a>
