...
@section('content')
    <div class="container-fluid px-4 py-3">
        ...
        @if (isset($cases) && request()->routeIs('public.search.find'))
            <div class="mt-5">
                @forelse ($cases as $case)
                    ...
                    <div class="card mb-4 shadow-sm border-0 w-100">
                        ...
                        <div class="card-body">
                            <p><strong>رقم الملف:</strong> {{ $case->case_number ?? 'غير محدد' }}</p>
                            <p><strong>رقم الدعوى:</strong> {{ $case->file_number ?? 'غير محدد' }}</p>
                            <p><strong>المحكمة:</strong> {{ $case->court_name ?? 'غير محدد' }}</p>
                            <p><strong>القاضي:</strong> {{ $case->jubge_name ?? 'غير محدد' }}</p>
                        </div>
                    </div>
