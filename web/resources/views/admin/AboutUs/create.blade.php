    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title card_title_center">إضافة بيانات جديدة</h3>
            </div>
            <div class="card-body">
                <form action="{{ route('aboutus.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <textarea name="text_ar" class="form-control" rows="4" required>{{ old('text_ar') }}</textarea>
                            @error('text_ar')
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <textarea name="text_en" class="form-control" rows="4" required>{{ old('text_en') }}</textarea>
                            @error('text_en')
                                <small id="helpId" class="text-muted text-danger">{{ $message }}</small>
                            @enderror
                        </div>
