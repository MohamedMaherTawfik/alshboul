...
@section('title', 'بحث المهمات الغير المنجزه')
@section('main_title_content', 'بحث المهمات الغير المنجزه')
@section('title_content', 'عرض')
@section('link_content')
    <a href="{{ route('mission.unfinished') }}"> جميع المهمات الغير المنجزه</a>
@endsection

@section('content')
    <div class="card p-4 mb-4">
        <form action="{{ route('mission.unfinished.search.go') }}" method="GET" class="row g-3">
    ...
    <a href="{{ route('mission.unfinished.search') }}"
        class="inline-block bg-[#000203FF] text-black px-4 py-2 rounded-lg hover:bg-green-700 transition">
        تصفية البحث
    </a>

    @if (route('mission.unfinished.search.go') == request()->url())
        <div class="card mb-4">
            <div class="card-header bg-primary text-white">
                <i class="fas fa-table me-1"></i>
                المهام الغير المكتملة
            </div>
            <div class="card-body">
                @if ($missions->count() > 0)
                                                ...
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        <div class="modal-header bg-primary text-white">
                                                            <h5 class="modal-title" id="missionModalLabel">تفاصيل المهمة
                                                            </h5>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    ...
                                                                    <p><strong>المحامي الثاني:</strong>
                                                                        {{ $mission->secondLawyer->name ?? 'غير محدد' }}
                                                                    </p>
                                                                </div>
                                                                <div class="col-md-6">
