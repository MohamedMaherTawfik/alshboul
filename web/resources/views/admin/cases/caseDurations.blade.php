...
@section('content')
    ...
    <div class="card shadow-sm border-0">
        <div class="card-header bg-white border-0 pt-3 pb-2 d-flex flex-wrap align-items-center gap-2">
            ...
            <a href="{{ route('cases.duration.create', $case) }}"
                ...
                <i class="bi bi-list me-1"></i> اضافه مده
            </a>
        </div>
        <div class="card-body">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const tableRows = document.querySelectorAll('#durationsTable tbody tr');
            ...
            function filterTable() {
                ...
                tableRows.forEach(row => {
                    ...
                    const factsCell = row.cells[4]?.innerText.toLowerCase() || '';
                    const startCell = row.cells[5]?.innerText.toLowerCase() || '';
                    const endCell = row.cells[6]?.innerText.toLowerCase() || '';
            ...
            [searchStart, searchEnd, searchUser, searchFacts].forEach(input => {
