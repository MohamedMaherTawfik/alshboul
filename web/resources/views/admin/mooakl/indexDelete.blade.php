...
@section('title', 'الموكلين المحذوفين ')
@section('main_title_content', ' قائمة الموكلين المحذوفين ')
@section('title_content', 'عرض')
@section('link_content')
    <a href="{{ route('client.indexDelete') }}"> موكلين محذوفين</a>
@endsection
@section('content')
    {{-- Success Message --}}
    @if (session('success'))
                        ...
                        <tbody>
                            ...
                            @foreach ($data as $info)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('client.restore', $info) }}" class="btn btn-info">استرجاع</a>
                                    </td>
                                </tr>
                            @endforeach
