    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title card_title_center">بيانات المحامين
                    <a href="{{ route('lawyer.create') }}" class="btn btn-success">إضافة جديد</a>
                </h3>
            </div>
        ...
        <div class="modal-dialog modal-l">
            <div class="modal-content">
                ...
                <div class="modal-body" id="months_of_year_model_body">
                    <form action="{{ route('lawyer.delete') }}" method="post">
                        @csrf
                        @method('delete')
