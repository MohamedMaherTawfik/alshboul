...
@section('content')
    <div class="container-fluid">
        ...
        <form action="{{ route('duration.search.go') }}" method="GET" class="row g-2 align-items-center mb-4">
        ...
        @if (route('duration.search.go') == request()->url())
            <!-- الجدول -->
                                ...
                                @else
                                    @foreach ($durations as $duration)
                                        ...
                                        <tr class="{{ $rowClass }}">
                                            ...
                                            <td><span class="duration-date">{{ $duration->period_start ?? '-' }}</span>
                                            </td>
                                            <td>
