<div>
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title card_title_center">تعديل القضية التنفيذية</h3>
        </div>
        <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" wire:model="office_file_number"
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="number" wire:model="suggested_file_number"
