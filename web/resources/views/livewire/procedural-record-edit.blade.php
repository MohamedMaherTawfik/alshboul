        ...
        <div class="card-body">
            <form wire:submit="save">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select wire:model="executive_case_id" class="form-control @error('executive_case_id') is-invalid @enderror">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input wire:model="session_date" type="date" class="form-control @error('session_date') is-invalid @enderror">
                            @error('session_date')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                @if($existingFiles->count() > 0)
                    <div class="form-group">
                        <label>الملفات المرفقة الحالية</label>
                                    ...
                                    @foreach($existingFiles as $file)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button wire:click="deleteFile({{ $file->id }})" class="btn btn-danger btn-sm" 
                ...
                <div class="form-group">
                    ...
                    <a href="{{ route('procedural-record.index', $proceduralRecord->executive_case_id) }}" class="btn btn-secondary">
