<div class="card">
    <div class="card-header">
        <h3 class="card-title">تعديل إجراء التسوية: {{ $settlement->user->name }}</h3>
    </div>
    <div class="card-body">
        <form wire:submit.prevent="save">
            ...
            <div class="form-group">
                ...
                <textarea wire:model="action_text" class="form-control @error('action_text') is-invalid @enderror" rows="3"></textarea>
                @error('action_text')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-primary">
                    <i class="fas fa-save"></i> تحديث الإجراء
                </button>
